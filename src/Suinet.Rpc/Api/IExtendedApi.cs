...
namespace Suinet.Rpc.Api
{
    public interface IExtendedApi
    {
        ...
        /// <returns></returns>
        Task<RpcResult<SuiPage_for_DynamicFieldInfo_and_ObjectID>> GetDynamicFieldsAsync(string parentObjectId, string cursor, ulong? limit);
        ...
        /// <returns></returns>
        Task<RpcResult<SuiObjectResponse>> GetDynamicFieldObjectAsync(string parentObjectId, string fieldName);
